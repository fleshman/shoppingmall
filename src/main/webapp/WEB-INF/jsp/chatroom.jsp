    ...
    <div class="" style="width: 80%;float:left;">
        ...
        <div class="" style="float: left">
         <!--<p class="am-kai">发送给 : <span id="sendto">全体成员</span><button class="am-btn am-btn-xs am-btn-danger" onclick="$('#sendto').text('全体成员')">复位</button></p>-->
            <p class="am-kai">发送给 : <span id="sendto">聊天对象</span>
              <button class="am-btn am-btn-xs am-btn-danger" onclick="$('#sendto').text('聊天对象')">复位</button></p>
        </div>
        <!-- 按钮区 -->
...
<script>
    ...
    if ('WebSocket' in window) {
       ...
       // ws = new WebSocket("ws://localhost:7777/chatServer");
    }
    else {
    ...
    function sendMessage(){
        ...
        var to = $("#sendto").text() == "聊天对象"? "": $("#sendto").text();
    ...
    function showChat(message){
        var to = message.to == null || message.to == ""? "聊天对象" : message.to;   //获取接收人
    ...
    function showImage(image) {
        ...
        var to = image.to == null || image.to == ""? "聊天对象" : image.to;   //获取接收人
    ...
    function addChat(user){
        var sendto = $("#sendto");
        var receive = sendto.text() == "聊天对象" ? "" : sendto.text() + ",";
