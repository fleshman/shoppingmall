...
<head>
    ...
    <title>数码 - jeegou开发站- Powered by JSPGOU</title>
...
<div id="Topbar" class="Topbar">
    <div class="ctr cf">
        ...
        <ul class="Topbar-welcome fl" id="top_user_bar">
            <li class="Topbar-welcome-item">${sessionUser.nickname}欢迎来到JSPGOU商城</li>
            <c:if test="${sessionUser==null}">
                <li class="Topbar-welcome-item"><a href="login">请登录</a></li>
            </c:if>
            <li class="Topbar-welcome-item"><a
                    href="register">免费注册</a></li>
        </ul>
...
<form id="tableForm" action="/shuma/index.htm" method="get">
    <div id="JS_list_panel" class="list-panel">
        <div class="list-wrap">
            <ul class="list-goods clearfix" style="width:1220px;">
                ...
                <li class="g-item">
                    <div class="g-dtl">
                        <a href="javascript:void(0)" target="_blank" onclick="goproduct(${p.pid})" >

                            <img  class="d-img" src="${pageContext.request.contextPath}/${p.pimgs}" />
    ...
    <script type="text/javascript">
        ...
        function goproduct(pid) {
            location.href="${pageContext.request.contextPath}/goproduct?pid="+pid;
        }
    </script>
